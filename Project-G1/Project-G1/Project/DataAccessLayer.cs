...
namespace Project
{
    class DataAccessLayer
    {
        ...
        public int DeleteAssignment(int AssignemntID)
        {
            if (dbConn.State == ConnectionState.Closed)
            {
                dbConn.Open();
            }
            string sqlDelete = "sp_DeleteAssignment '" + AssignemntID + "'";
            dbCmd = new SqlCommand(sqlDelete, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }
        ...
        public DataTable GetActiveAssignments()
        {
            ...
            dbCmd = new SqlCommand("sp_GetActiveAssignments", dbConn);
            dbAdapter = new SqlDataAdapter(dbCmd);
            DataTable dtAssignments = new DataTable();
            dbAdapter.Fill(dtAssignments);
        ...
        public DataTable GetDeletedAssignments()
        {
            ...
            dbCmd = new SqlCommand("sp_GetDeletedAssignments", dbConn);
            dbAdapter = new SqlDataAdapter(dbCmd);
            DataTable dtAssignments = new DataTable();
            dbAdapter.Fill(dtAssignments);
            return dtAssignments;
        ...
        public int RecoverAssignment(int assignmentID)
        {
            ...
            string sqlRecover = "sp_RecoverAssignment '" + assignmentID + "'";
            dbCmd = new SqlCommand(sqlRecover, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }
        ...
        public int InsertAssignment(string projectID, string studentID, DateTime dateAssigned, string roleOnProject)
        {
            ...
            string sqlInsert = "sp_InsertAssignment '" + projectID + "','" + studentID + "','" + dateAssigned + "','" + roleOnProject + "'";
            dbCmd = new SqlCommand(sqlInsert, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }
        ...
        public int UpdateAssignment(int assignmentID, string projectID, string studentID, DateTime dateAssigned, string roleOnProject, int studentProjectMark, int studentBuddyMark, string comment)
        {
            ...
            string sqlRecover = "sp_UpdateAssignment '" + assignmentID + "','" + projectID + "','" + studentID + "','" + dateAssigned + "','" + roleOnProject + "','" + studentProjectMark + "','" + studentBuddyMark + "','" + comment + "'";
            dbCmd = new SqlCommand(sqlRecover, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }
        ...
        //Delete an AssignmentTask
        public int DeleteTaskAssignment(int TaskAssignemntID)
        {
            if (dbConn.State == ConnectionState.Closed)
            {
                dbConn.Open();
            }
            string sqlDelete = "sp_DeleteTaskAssignment '" + TaskAssignemntID + "'";
            dbCmd = new SqlCommand(sqlDelete, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }

        //Get active AssignmentTasks
        public DataTable GetActiveTaskAssignments()
        {
            ...
            dbCmd = new SqlCommand("sp_GetActiveTaskAssignments", dbConn);
            dbAdapter = new SqlDataAdapter(dbCmd);
            DataTable dtAssignments = new DataTable();
            dbAdapter.Fill(dtAssignments);
            return dtAssignments;
        ...
        public DataTable GetDeletedTaskAssignments()
        {
            ...
            dbCmd = new SqlCommand("sp_GetDeletedTaskAssignments", dbConn);
            dbAdapter = new SqlDataAdapter(dbCmd);
            DataTable dtAssignments = new DataTable();
            dbAdapter.Fill(dtAssignments);
            return dtAssignments;
        ...
        public int RecoverTaskAssignment(int assignmentTaskID)
        {
            ...
            string sqlRecover = "sp_RecoverTaskAssignment '" + assignmentTaskID + "'";
            dbCmd = new SqlCommand(sqlRecover, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }

        //Insert new AssignmentTask
        public int InsertTaskAssignment(int projectTaskID, string studentID, string assignmentRole, DateTime dateAssigned )
        {
            ...
            string sqlInsert = "sp_InsertTaskAssignment '" + projectTaskID + "','" + studentID + "','" + assignmentRole + "','" + dateAssigned + "'";
            dbCmd = new SqlCommand(sqlInsert, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }

        //Update an AssignmentTask
        public int UpdateTaskAssignment(int assignmentTaskID, int projectID, string studentID, string assignmentRole, DateTime dateAssigned,  int assignmentMark, string comment)
        {
            if (dbConn.State == ConnectionState.Closed)
            {
                dbConn.Open();
            }
            string sqlRecover = "sp_UpdateTaskAssignment '" + assignmentTaskID + "','" + projectID + "','" + studentID + "','" + assignmentRole + "','" + dateAssigned + "','" + assignmentMark + "','" + comment + "'";
            dbCmd = new SqlCommand(sqlRecover, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }

        //====================================================================BUDDY RATING METHODS====================================================================

        //Get all BuddyRatings
        public DataTable GetAllBuddyRatings()
        {
            ...
            dbCmd = new SqlCommand("sp_GetAllBuddyRatings", dbConn);
            dbAdapter = new SqlDataAdapter(dbCmd);
            DataTable dtBuddyRatings = new DataTable();
            dbAdapter.Fill(dtBuddyRatings);
            return dtBuddyRatings; 
        }

        //Insert a new BuddyRating
        public int InsertBuddyRating(string projectID, string studentID, string evaluatorStudentID, int mark)
        {
            ...
            string sqlInsert = "sp_InsertBuddyRating '" + projectID + "','" + studentID + "','" + evaluatorStudentID + "','" + mark + "'";
            dbCmd = new SqlCommand(sqlInsert, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }

        //Update a BuddyRating
        public int UpdateBuddyRating(int buddyID, string projectID, string studentID, string evaluatorStudentID, int mark)
        {
            ...
            string sqlUpdate = "sp_UpdateBuddyRating '" + buddyID + "','" + projectID + "','" + studentID + "','" + evaluatorStudentID + "','" + mark + "'";
            dbCmd = new SqlCommand(sqlUpdate, dbConn);
            int x = dbCmd.ExecuteNonQuery();
            return x;
        }
